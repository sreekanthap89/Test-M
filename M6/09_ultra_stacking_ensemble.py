"""
=============================================================
 STEP 9: ULTRA STACKING ENSEMBLE ENGINE & WHEELING SYSTEM (EASY6)
=============================================================
 LEARNING GOAL:
...
def extract_features_for_draw(draws_history, pool_size=POOL):
    """
    Extracts rich engineered features for predicting the next draw based on past history:
      1. Delay Gaps (draws since ball 1..39 was last drawn)
      2. Rolling Frequencies (3-draw, 5-draw, 10-draw)
      3. Zone Concentration Ratios (Z1: 1-10, Z2: 11-20, Z3: 21-30, Z4: 31-39)
    ...
    features.append(np.mean(last_sums) if last_sums else 120.0)

    last_highs = [sum(1 for b in d if b > 19) for d in recent_3]
    features.append(np.mean(last_highs) if last_highs else 3.0)
...
def prepare_stacking_dataset(df, lookback=10, pool_size=POOL):
...
def main():
    print("============================================================")
    print("  STEP 9 — ULTRA STACKING ENSEMBLE ENGINE & WHEELING (EASY6)")
    print("============================================================")
    ...
    top_6_indices = np.argsort(stack_probs)[::-1][:DRAW_SIZE]
    top_6_numbers = sorted((top_6_indices + 1).tolist())

    print("\n============================================================")
    print("  PHASE 1: ULTRA STACKING PREDICTION")
    print("============================================================")
    print(f"Stacking Ensemble Top 6 Single Predicted Ticket:  ★  {top_6_numbers}  ★")
    print(f"Stacking Ensemble Top 14 Candidate Pool        : {top_14_numbers}")

    print("\n============================================================")
    print("  PHASE 2: COMBINATORIAL WHEELING")
    print("============================================================")
    print(f"Buying all combinations of 14 numbers = {math.comb(14, 6)} tickets.")
    ...
    ax2.axis("off")
    summary_text = (
        "★ ULTRA STACKING TOP-6 PREDICTED TICKET ★\n"
        f"  {top_6_numbers}\n\n"
