...
from utils import get_run_folder, load_data, POOL, DRAW_SIZE, CSV_FILE
...
def main():
    ...
    table_data = [
        ...
        ["Step 03", "Probability Curves", "Fits statistical bell curves for sum totals", "N/A", "Optimal ticket sum = 95 to 145"],
    ...
    for (row, col), cell in table.get_celld().items():
        ...
        if row == 0:
            ...
            elif col == 4 and ("GRAND" in cell.get_text().get_text() or "Dormancy" in cell.get_text().get_text()):
                cell.get_text().set_weight("bold")
