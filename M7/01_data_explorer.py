"""
=============================================================
 STEP 1: DATA EXPLORATION — EMIRATES DRAW MEGA7
=============================================================
 LEARNING GOAL:
...
def load_data(path: str) -> pd.DataFrame:
    """Load and clean the MEGA7 CSV file."""
    ...
    # Build a flat list column of the 7 drawn numbers per row
...
def main() -> None:
    ...
    print_section("DATASET OVERVIEW — EMIRATES DRAW MEGA7")
  ...
  For MEGA7, numbers are drawn from 1–{POOL}.
...
""")
    ...
    fig.suptitle("STEP 1 — Emirates Draw MEGA7 — Data Exploration", fontsize=16, fontweight="bold")
    ...
    print("""
  ✔  How to load and clean real-world MEGA7 CSV data with pandas
